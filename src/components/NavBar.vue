<template>
    <div class="flex flex-col justify-center items-center w-full h-auto p-2 lg:gap-2 bg-red-500 text-white">
        <!-- NAV SUPERIOR -->
        <nav class="flex justify-between items-center w-full lg:w-5/6 text-sm font-light">
            ...
            <div class="hidden lg:flex justify-center items-center gap-2">
                ...
                <span>|</span>
                <a href="#" class="no-underline">Github</a>
                <span>|</span>
                <a href="#" class="no-underline">Youtube</a>
                <span>|</span>
                <a href="#" class="no-underline">WhatApp</a>
            </div>
            ...
            <div class="flex justify-center items-center gap-2 lg:gap-4">
                ...
                <div class="flex justify-center items-center gap-2 cursor-pointer">
                    <span class="h-6 w-6 bg-black rounded-full"></span>
                    <span>User</span>
                </div>
            </div>
        </nav>
        ...
        <nav class="flex justify-between lg:justify-evenly items-center w-full lg:w-5/6 pt-2 lg:p-2">
            ...
            <div class="flex justify-between items-center gap-1 w-3/6 lg:w-3/5 bg-white pr-1">
                ...
                <button class="flex justify-center items-center w-8 h-8 bg-red-500 text-white">
            ...
            <!-- BOX DE CARRINHO -->
            <div class="flex justify-center items-center gap-1 text-white cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
